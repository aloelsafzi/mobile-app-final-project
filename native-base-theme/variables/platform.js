...
export default {
  ...
  // Color
  brandPrimary: platform === PLATFORM.IOS ? '#007aff' : '#4f6d7a',
  brandInfo: '#62B1F6',
  brandSuccess: '#5cb85c',
  brandDanger: '#d9534f',
  brandWarning: '#f0ad4e',
  ...
  // Footer
  footerHeight: 55,
  footerDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#4f6d7a',
  ...
  tabActiveBgColor: platform === PLATFORM.IOS ? '#cde1f9' : '#4f6d7a',

  // Header
  toolbarBtnColor: platform === PLATFORM.IOS ? '#007aff' : '#fff',
  toolbarDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#4f6d7a',
  ...
  toolbarDefaultBorder: platform === PLATFORM.IOS ? '#a7a6ab' : '#4f6d7a',
  ...
  listItemSelected: platform === PLATFORM.IOS ? '#007aff' : '#4f6d7a',
  ...
  segmentBorderColorMain: platform === PLATFORM.IOS ? '#a7a6ab' : '#4f6d7a',
  ...
  tabDefaultBg: platform === PLATFORM.IOS ? '#F8F8F8' : '#4f6d7a',
